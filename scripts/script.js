...
let theWords = ["CIGAR", "REBUT", "SISSY", "HUMPH", "AWAKE", "BLUSH", "FOCAL", "EVADE", "NAVAL", "SERVE", "HEATH", "DWARF", "MODEL", "KARMA", "STINK", "GRADE", "QUIET", "BENCH", "ABATE", "FEIGN", "SPELL", "MAJOR", "DEATH", "FRESH", "CRUST", "STOOL", "COLOR", "MARRY", "REACT", "BATTY", "PRIDE", "FLOSS", "HELIX", "CROAK", "STAFF", "PAPER", "LLAMA", "UNFED", "WHELP", "TRAWL", "OUTDO", "ADOBE", "CRAZY", "SOWER", "REPAY", "DIGIT", "CRATE", "CLUCK", "SPIKE", "MIMIC", "POUND", "MAXIM", "LINEN", "UNMET", "FLESH", "FORTH", "FIRST", "STAND", "BELLY", "IVORY", "SEEDY", "PRINT", "YEARN", "DRAIN", "BRIBE", "STOUT", "PANEL", "CRASS", "FLUME", "AWFUL", "AGREE", "ERROR", "SWIRL",
"ARGUE", "BLEED", "DELTA", "FLICK", "TOTEM", "FRONT", "SPACE", "SHRUB", "PARRY", "BIOME", "LABEL", "START", "GREET", "GONER", "GOLEM",
"LUSTY", "LOOPY", "ROUND", "AUDIT", "LYING", "GAMMA", "LABOR", "ISLES", "CIVIC", "FORGE", "CORNY", "MOULD", "BASIC", "SALAD", "AGATE",
"SPICY", "SPRAY", "ESSAY", "FJORD", "SPEND", "KEBAB", "GUILD", "ABACK", "MOTOR", "ALONE", "HATCH", "HYPER", "THUMB", "IRATE", "AUDIO",
"OUGHT", "HASTE", "CLICK", "ALTAR", "PULPY", "BLURT", "COAST", "GROIN", "PILOT", "JAUNT", "ABYSS", "DOZEN", "FLING", "ERODE", "WORLD",
"GAUDY", "CHILL", "HERON", "VODKA", "FINER", "SURER", "RADIO", "ROUGE", "PERCH", "RETCH", "WROTE", "CLOCK", "STORE", "PROVE", "GRIME",
"BRING", "SOLVE", "CHEAT", "EXULT", "USHER", "TRIAD", "BREAK", "RHINO", "VIRAL", "VITAL", "TRACE", "PEACH", "CHAMP", "SOLAR", "AROMA" ];
...
for(let theButton of theKeyboard){
    theButton.addEventListener("click", function(event){
        ...
        //if their word is five letters long, they hit enter, and they do not hit back, then we can add their word to the divs
        else if(theirWord.length < 5 && event.target.innerText != "ENTER" && event.target.innerText != "BACK"){
            ...
            theRow[theCurrentRow].children[theCurrentLetter].innerText = theButton.innerText;
